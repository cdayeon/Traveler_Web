...
<head>
    ...
    <title>여행지도</title>
    <style>
#traveler_map {margin: 0; height: 980px;}
.map_wrap * {margin:0;padding:0;font-family:'Malgun Gothic',dotum,'돋움',sans-serif;font-size:12px;}
.map_wrap a, .map_wrap a:hover, .map_wrap a:active{color:#000;text-decoration: none;}
.map_wrap {margin:0;position:relative;width:100%;height:700px;padding:0;font-family:'Malgun Gothic',dotum,'돋움',sans-serif;font-size:12px;}
