...
//-----그룹페이지처리 이전 --------------------------------------------------------------------------------------------		
		if(isPrevPage){
			...
			sb.append("'><img src='resources/img/qna_left.png'></a>");
		}
		else
			sb.append("<img src='resources/img/qna_left.png'>");
...
//-----그룹페이지처리 다음 ----------------------------------------------------------------------------------------------
		if(isNextPage){
			...
			sb.append(nowPage);*/
			sb.append("'><img src='resources/img/qna_right.png'></a>");
		}
		else
			sb.append("<img src='resources/img/qna_right.png'>");
//---------------------------------------------------------------------------------------------------------------------	    
